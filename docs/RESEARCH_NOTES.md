...
The Build and Create woodworking task uses Mojang's published crafting rules. The official [How to craft](https://www.minecraft.net/en-us/article/how-craft) guide confirms that a crafting table unlocks the full recipe set and that one wood block produces four planks. The official [Taking Inventory: Door](https://www.minecraft.net/en-us/article/taking-inventory--door) article specifies six matching planks in a two-wide, three-high shape. The prototype collects two oak logs, produces eight oak planks, consumes six in either valid horizontal position of that shaped recipe, and returns the game's three-door output stack. Its scenery and block art are original CSS rather than copied Minecraft assets.
