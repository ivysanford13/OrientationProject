...
(function careerLaunchpadApp() {
  ...
  function renderMinecraftDoorBody(node) {
    ...
    var survivalIcons = new Array(10).fill('<i></i>').join('');
    ...
    return '<div class="minecraft-game" data-minecraft-game><div class="mc-mission-bar"><div><span class="mc-mission-number">0' + stageNumber + '</span><div><small>CURRENT OBJECTIVE</small><strong>' + escapeHtml(stageTitle) + '</strong></div></div><ol aria-label="Crafting progress"><li class="' + (stageNumber > 1 ? 'is-done' : 'is-active') + '">CHOP</li><li class="' + (stageNumber > 2 ? 'is-done' : stageNumber === 2 ? 'is-active' : '') + '">PLANKS</li><li class="' + (game.complete ? 'is-done' : stageNumber === 3 ? 'is-active' : '') + '">DOOR</li></ol></div><div class="mc-world mc-world--' + game.position + '" style="--player-x:' + playerX + '%"><div class="mc-sky" aria-hidden="true"><i class="mc-cloud mc-cloud--one"></i><i class="mc-cloud mc-cloud--two"></i><i class="mc-sun"></i><i class="mc-hill mc-hill--one"></i><i class="mc-hill mc-hill--two"></i></div><div class="mc-ground" aria-hidden="true"></div><div class="mc-world-details" aria-hidden="true"><i class="mc-grass mc-grass--one"></i><i class="mc-grass mc-grass--two"></i><i class="mc-flower"></i><i class="mc-stone"></i></div>' + treeAction + tableAction + '<div class="mc-player" aria-label="BYU cougar explorer holding an axe"><span class="mc-axe" aria-hidden="true"></span><img src="' + EXPLORER_AVATAR_SRC + '" width="1254" height="1254" alt=""></div>' + worldAction + (game.complete ? '<span class="mc-built-door" aria-hidden="true"><i></i><b></b><em></em></span>' : '') + '</div><div class="mc-lower"><section class="mc-inventory" aria-labelledby="mc-inventory-title"><div class="mc-panel-title"><strong id="mc-inventory-title">INVENTORY</strong><span>9-SLOT HOTBAR</span></div><div class="mc-hotbar" aria-label="Nine-slot hotbar"><span class="mc-slot' + (game.logs ? ' has-item' : '') + '">' + (game.logs ? '<i class="mc-item mc-item--log"></i><b>' + game.logs + '</b>' : '') + '<small>LOG</small></span><span class="mc-slot' + (loosePlanks ? ' has-item' : '') + '">' + (loosePlanks ? '<i class="mc-item mc-item--plank"></i><b>' + loosePlanks + '</b>' : '') + '<small>PLANK</small></span><span class="mc-slot' + (game.doors ? ' has-item' : '') + '">' + (game.doors ? '<i class="mc-item mc-item--door"></i><b>' + game.doors + '</b>' : '') + '<small>DOOR</small></span><span class="mc-slot has-item is-equipped"><i class="mc-item mc-item--axe"></i><small>AXE</small></span><span class="mc-slot"></span><span class="mc-slot"></span><span class="mc-slot"></span><span class="mc-slot"></span><span class="mc-slot"></span></div><div class="mc-survival-bars" aria-hidden="true"><span class="mc-health">' + survivalIcons + '</span><span class="mc-hunger">' + survivalIcons + '</span></div><p class="mc-status" role="status" aria-live="polite">' + escapeHtml(game.feedback) + '</p></section><section class="mc-craft-panel' + (craftingMarkup ? ' is-open' : '') + '" aria-label="Crafting table workspace">' + (craftingMarkup || '<div class="mc-table-closed"><span class="mc-mini-table" aria-hidden="true"><i></i><b></b><em></em></span><div><strong>CRAFTING TABLE</strong><p>Gather two logs, then bring them here.</p></div></div>') + '</section></div><aside class="mc-recipe-note"><strong>TRUE RECIPE</strong><span>1 oak log → 4 oak planks</span><span>6 matching planks → 3 oak doors</span></aside></div>';
  }
